...
VectorXf QuadEstimatorEKF::PredictState(VectorXf curState, float dt, V3F accel, V3F gyro)
{
  ...
  accel = attitude.Rotate_BtoI(accel)+ V3F(0,0,-9.81f); 

  predictedState(3) +=  dt * accel.x;
  predictedState(4) +=  dt * accel.y;
  predictedState(5) +=  dt * accel.z;
  /////////////////////////////// END STUDENT CODE ////////////////////////////
...
MatrixXf QuadEstimatorEKF::GetRbgPrime(float roll, float pitch, float yaw)
{
  ...
  ////////////////////////////// BEGIN STUDENT CODE ///////////////////////////
  //in order of roll , pitch and yaw
...
void QuadEstimatorEKF::Predict(float dt, V3F accel, V3F gyro)
{
  ...
  ////////////////////////////// BEGIN STUDENT CODE ///////////////////////////
  MatrixXf predictMatrix(3,1);
  predictMatrix(0,0) = accel.x*dt;
  predictMatrix(1,0) = accel.y*dt;
  predictMatrix(2,0) = accel.z*dt;
  
  gPrime(0,3) = dt;
  gPrime(1,4) = dt;
  gPrime(2,5) = dt;
  gPrime(3,6) = (RbgPrime * predictMatrix)(0,0);
  gPrime(4,6) = (RbgPrime * predictMatrix)(1,0);
  gPrime(5,6) = (RbgPrime * predictMatrix)(2,0);
